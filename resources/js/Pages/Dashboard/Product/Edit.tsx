...
import { getProductById, updateProduct, type UpdateProductPayload } from "../../../api/features/dashboard/products";
...
export default function EditProduct({ id }: EditProductProps) {
    ...
    const removeImage = () => {
        setImageFile(null);
        if (originalImage) {
            setImagePreview(`/storage/${originalImage}`);
        } else {
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">Loading product...</p>
                </div>
            </div>
        );
    }
